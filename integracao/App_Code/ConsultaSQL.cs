...
public class ConsultaSQL : System.Web.Services.WebService
{
		...
		// [WebMethod]
        // public void listaTempoEstimado()
        // {
		//     string msgErro;
        //     ArrayList meuArray = new ArrayList();
        ...
        //     string sql = "select c.node_id, c.value, ifnull(a.estimated_exec_duration,0) " +
        //                    " from tcversions a inner join executions b " +
        //                    " on a.id = b.tcversion_id " +
        //                    " inner join cfield_design_values c " +
        //                    " on c.node_id = a.id " +
        //                    " where b.testplan_id = (select testplan_id from testplan_tcversions where creation_ts = '2017-09-25 09:04:28' limit 1) " +
        ...
        //             g.p1 = reader.GetInt32(0);
        //             g.p2 = reader.GetInt32(1);
        //             g.p3 = reader.GetInt32(2);
        ...
        // [WebMethod]
        // public void listaTempoRealizado()
        // {
		//     string msgErro;
        //     ArrayList meuArray = new ArrayList();
        ...
        //     string sql = "select c.node_id, c.value, ifnull(b.execution_duration,0) " +
        //                    " from tcversions a inner join executions b " +
        //                    " on a.id = b.tcversion_id  " +
        //                    " inner join cfield_design_values c  " +
        //                    " on c.node_id = a.id  " +
        ...
        public void calculoTempo(string dataHora)
        {
            ...
            string sql = "select c.node_id, c.value, ifnull(a.estimated_exec_duration,0) 'Estimado' , ifnull(b.execution_duration, 0) 'Realizado' " +
                           " from tcversions a inner join executions b " +
                           " on a.id = b.tcversion_id " +
                           " inner join cfield_design_values c " +
                           " on c.node_id = a.id " +
